...
<body>
 ...
 <!-- ===========================
    ...
    <br><br><br><br><br><script src="assets/js/cs.js"></script>
    <h2>Inscription</h2>
    <?php
        <form class="my-account-form" method="post" action="acceuil.html">

            <label for="name">Votre Nom *</label>
            <input type="text" name="Username" required><?php echo $name[ID]; ?> 
            ...
            <br><label for="taille">Votre Taille *</label>
            <input type="number" id="taille" name="Username" required>

            <label for="poids">Votre Masse *</label>
            <input type="number" id="poids" name="Username" required>

            <br><label for="password">Votre Adresse Email *</label>
            <input type="email" id="emaill" name="Username" required>

            <label for="password">Mot de passe *</label>
            <input type="password" id="password" name="Username" required>

            <label for="password">Confirmation du Mot de passe *</label>
            <input type="password" id="password2" name="Username" required>

            <button type="submit" class="btn" onclick="verification()">Connexion </button>
            <div class="wrapper">
            <label for="choix">Vous acceptez toutes les conditions du site *</label>
